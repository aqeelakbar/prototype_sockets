...
Touch.CONTROLS_CSS_NOFILL =
  "opacity:0.1; z-index: 11000; border-style: dashed; border-width: 1px";
...
Touch.init = function() {
  ...
  Touch.dpad["upleft"] = Touch.createDPadButton(
    "upleft",
    function() {
  ...
  Touch.dpad["upleft"].style.bottom =
    Touch.DPAD_BUTTON_HEIGHT_PERCENT * 2 + "%";

  Touch.dpad["up"] = Touch.createDPadButton(
    "up",
    function() {
      Controls.current.moveForward = true;
    },
  ...
  Touch.dpad["upright"] = Touch.createDPadButton(
    "upright",
    function() {
      Controls.current.moveForward = true;
  ...
  Touch.dpad["upright"].style.bottom =
    Touch.DPAD_BUTTON_HEIGHT_PERCENT * 2 + "%";
  Touch.dpad["upright"].style.left = Touch.DPAD_BUTTON_WIDTH_PERCENT * 2 + "%";

  Touch.dpad["left"] = Touch.createDPadButton(
    "left",
    function() {
      Controls.current.turnLeft = true;
    },
  ...
  Touch.dpad["right"] = Touch.createDPadButton(
    "right",
    function() {
      Controls.current.turnRight = true;
    },
  ...
  Touch.dpad["downleft"] = Touch.createDPadButton(
    "downleft",
    function() {
  ...
  Touch.dpad["down"] = Touch.createDPadButton(
    "down",
    function() {
      Controls.current.moveBackward = true;
    },
  ...
  Touch.dpad["downright"] = Touch.createDPadButton(
    "downright",
    function() {
      Controls.current.moveBackward = true;
      Controls.current.turnRight = true;
  ...
  Touch.dpad["downright"].style.left =
    Touch.DPAD_BUTTON_WIDTH_PERCENT * 2 + "%";

  // create a dummy button in the middle to accept touchstarts. Override the default CSS for no red colour.
  Touch.dpad["deadzone"] = Touch.createDPadButton(
    "deadzone",
    function() {
      // no op
    },
...
Touch.createDPadButton = function(
  id,
  pressFunction,
  unpressFunction,
  cssOverride
  ...
  button.addEventListener("touchmove", function(event) {
    ...
    if (elementBeingTouched === Touch.lastDPadPressed) {
      // no change, no op
    } else if (elementBeingTouched in Touch.dpad) {
      // verify we moved onto a dpad button
